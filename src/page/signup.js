    ...
    render() {
        ...
        <div class="bg-white w-full md:max-w-md lg:max-w-full  md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
          ...
          <div class="w-full h-100">
            ...
            <form class="mt-6" id="formSignup" action="#" method="POST">
              <div>
              ...
              <div class="mt-4">
                ...
                <input type="text" name="" id="username" placeholder="Enter Password" minlength="6" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
